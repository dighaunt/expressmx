...
>(({ className, size, ...props }, ref) => {
  ...
  return <UIButton.Spinner ref={ref} {...props} className={buttonSpinnerStyle({ parentVariants: { size: parentSize }, class: className, size: size as 'default' | 'sm' | 'lg' | 'icon' | undefined })} />;
});
